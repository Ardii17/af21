  ...
  return (
    <section ref={pricingRef} className="bg-[#EA3546] flex flex-col gap-8">
      <div className="flex flex-col gap-12 items-center justify-center py-10 px-4 min-md:px-12 min-lg:px-20">
        ...
        <div className="flex flex-col min-md:flex-row gap-8 w-full items-stretch">
          <CardPricing
            price="Rp. 500.000"
            ...
            options={[
              ...
              "Satu halaman landing page/portofolio",
              "Desain ekslusif (tanpa template)",
          ...
          <CardPricing
            ...
            options={[
              "Website dengan domain khusus",
              "1 halaman landing page/portofolio",
              "Desain ekslusif (tanpa template)",
              "Integrasi media sosial dan fitur tambahan sesuai kebutuhan",
              "Responsif di berbagai perangkat",
              "Revisi (maksimal 2 kali)",
              "Dukungan teknis selama 1 bulan",
              "Garansi uang kembali jika tidak puas (Uang domain tidak bisa di refund)",
            ]}
...
function CardPricing({ price, discount, title, desc, options, onContact }) {
  return (
    <div className="relative z-10 w-full min-lg:w-2/3" data-aos="fade-up">
      <div className="bg-white h-full border-2 border-black w-full rounded-2xl p-4 flex flex-col justify-between">
